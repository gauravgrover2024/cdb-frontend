...
const savedCars = [
  {
    ...
    image: "",
    tone: "from-[#f7f3ec] via-white to-[#edf2f7]",
  },
  {
    name: "Tata Safari",
    ...
    image: "",
    tone: "from-[#f7f3ec] via-white to-[#edf7f2]",
  },
  {
    name: "Kia Seltos",
    meta: "1.5 HTX IVT",
    ...
    image: "",
    tone: "from-[#f7f3ec] via-white to-[#f1eff8]",
  },
];
...
function ActionTileGrid({ onAsk, loading }) {
  return (
    <div className="grid grid-cols-2 overflow-hidden rounded-[24px] border border-[#dbe3ef] bg-white/88 shadow-[0_22px_70px_-54px_rgba(56,46,32,0.42)] backdrop-blur-xl md:grid-cols-4 lg:grid-cols-8">
      {actionTiles.map((tile) => {
        ...
        return (
          <button
            ...
            disabled={loading}
            className="group min-h-[118px] border-b border-r border-[#e2e8f0] px-3 py-4 text-center transition hover:bg-[#eff6ff]/75 disabled:cursor-not-allowed disabled:opacity-50 md:min-h-[128px]"
          >
    ...
    >
      ...
      {image ? (
        <img
          src={image}
          alt={alt}
          className="absolute left-1/2 top-1/2 max-h-[112px] w-[88%] -translate-x-1/2 -translate-y-1/2 object-contain drop-shadow-[0_20px_22px_rgba(56,46,32,0.22)]"
        />
      ) : (
        <div className="absolute left-1/2 top-1/2 flex h-20 w-40 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-[34px] bg-gradient-to-br from-[#2f3540] via-[#1f2937] to-[#080b12] text-white shadow-[0_18px_50px_-28px_rgba(15,23,42,0.8)]">
...
function MiniCarArt({ image, tone = "from-[#f7f3ec] via-white to-[#edf2f7]" }) {
  return (
    <div
      className={cx(
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {trendingCars.map((car) => (
          <button
            ...
            disabled={loading}
            className="group overflow-hidden rounded-[24px] border border-[#dbe3ef] bg-white p-3 text-left shadow-[0_18px_60px_-48px_rgba(56,46,32,0.55)] transition hover:-translate-y-1 hover:border-[#bfdbfe] hover:shadow-[0_26px_78px_-50px_rgba(154,106,36,0.45)] disabled:cursor-not-allowed disabled:opacity-50"
          >
            <div className="relative">
...
function EmptyHomeExperience({ onAsk, loading }) {
  return (
    <motion.div
      ...
      className="space-y-6"
    >
      <section className="relative overflow-hidden rounded-[34px] border border-[#dbe3ef] bg-[linear-gradient(135deg,#ffffff_0%,#f8fafc_48%,#eff6ff_100%)] p-5 shadow-[0_34px_100px_-72px_rgba(15,23,42,0.48)] md:p-8">
        <div className="pointer-events-none absolute -right-28 -top-28 h-80 w-80 rounded-full bg-[#dbeafe]/35 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-32 left-1/3 h-80 w-80 rounded-full bg-[#dbeafe]/45 blur-3xl" />
        ...
        <div className="relative grid items-center gap-8 xl:grid-cols-[340px_minmax(0,1fr)]">
          ...
          <div className="max-w-4xl">
            ...
            <h2 className="font-serif text-[42px] font-semibold leading-[1.02] tracking-[-0.065em] text-[#111111] md:text-[64px] xl:text-[72px]">
              Hi, I’m <span className="text-[#2563eb]">ACI Assist.</span>
              <br />
              Ask me anything about new cars.
            </h2>

            <div className="mt-6 max-w-3xl rounded-[24px] border border-[#dbe3ef] bg-white/86 p-5 shadow-[0_22px_70px_-54px_rgba(20,16,10,0.45)] backdrop-blur-xl">
  ...
  return (
    <aside className="hidden space-y-4 xl:block">
      <section className="overflow-hidden rounded-[28px] border border-[#263449] bg-[radial-gradient(circle_at_20%_0%,#1e3a8a_0%,#0f172a_42%,#020617_100%)] p-4 text-white shadow-[0_28px_80px_-58px_rgba(15,23,42,0.85)]">
        <div className="relative">
          <div className="pointer-events-none absolute -right-12 -top-12 h-32 w-32 rounded-full bg-[#8fa3bf]/25 blur-2xl" />
          ...
          <button
            type="button"
            onClick={onHelp}
            className="relative mt-4 w-full rounded-[18px] bg-white px-4 py-3 text-sm font-black text-[#111827] shadow-[0_18px_45px_-30px_rgba(255,255,255,0.75)] transition hover:-translate-y-0.5"
          >
      ...
      <section className="rounded-[28px] border border-[#dbe3ef] bg-white/92 p-4 shadow-[0_24px_70px_-58px_rgba(20,16,10,0.5)] backdrop-blur-xl">
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <button
          type="button"
          className="hidden h-11 w-11 shrink-0 items-center justify-center rounded-[17px] border border-[#dbe3ef] bg-[#f9fafb] text-[#4b5563] transition hover:bg-white md:flex"
        ...
        {messages.map((message) => (
          ...
          >
            {message.role === "user" ? (
              ...
              <div className="w-full max-w-full rounded-[30px] border border-[#dbe3ef] bg-white/88 p-4 shadow-[0_22px_70px_-56px_rgba(56,46,32,0.45)] backdrop-blur-xl md:p-5">
                ...
                {hasCanvasPayload(message) ? (
                  <div className="mt-5 overflow-hidden rounded-[26px] border border-[#dbe3ef] bg-[#f8fafc] p-2 shadow-inner">
...
function ChatExperience({
  ...
  return (
    <section className="w-full space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-[28px] border border-[#dbe3ef] bg-white/85 px-5 py-4 shadow-[0_22px_70px_-58px_rgba(20,16,10,0.45)] backdrop-blur-xl">
        <div>
          <h2 className="font-serif text-3xl font-semibold tracking-[-0.05em] text-[#111827] md:text-4xl">
            ACI Assist chat
          </h2>
          <p className="mt-1 text-sm font-semibold text-[#6b7280]">
            Answers, recommendations and buying tools in one intelligent
            conversation.
          </p>
        </div>
        ...
        <button
          type="button"
          onClick={onClear}
          className="inline-flex items-center gap-2 rounded-[18px] border border-[#cbd5e1] bg-white px-4 py-2.5 text-sm font-black text-[#1e293b] shadow-sm transition hover:border-[#2563eb] hover:bg-[#eff6ff] hover:text-[#1e40af]"
        >
          <Sparkles size={15} />
          New chat
        </button>
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f5f7fb] text-[#0f172a]">
      ...
      <div className="relative flex min-h-screen flex-col">
        ...
        <div className="fixed inset-x-0 bottom-0 z-50 border-t border-white/70 bg-[#f6f7f9]/76 px-4 pb-4 pt-3 shadow-[0_-24px_80px_-58px_rgba(15,23,42,0.65)] backdrop-blur-2xl md:px-6 xl:px-7">
            ...
            <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_310px]">
              <div className="min-w-0">
                ...
                <p className="mt-2 text-center text-[10px] font-semibold text-[#8b8f98]">
                  ACI Assist can make mistakes. Please verify important
                  information.
                </p>
              </div>
