  ...
  const initialValues = useMemo(() => {
    if (renewFromCase) {
      ...
      return {
        ...
        newCngIdv: 0,
        newAccessoriesIdv: 0,
        newOwnDamageAmount: 0,
        newBasicOwnDamageAmount: 0,
        newOwnDamageBeforeNcb: 0,
        newThirdPartyAmount: 0,
        newBasicThirdPartyAmount: 0,
        newAddOnsTotal: 0,
        newTotalPremium: 0,
        newSelectedAddOns: [],
        totalPremium: 0,
        ...
        customerPaymentToInsurer: 0,
        inhousePaymentExpected: 0,
        inhousePaymentReceived: 0,
        subventionAmount: 0,
        subventionNotRecoverable: 0,
        paymentHistory: [],
