...
const PasswordInput = ({ value, onChange, show, onToggleShow, placeholder }) => (
  <div className="relative">
    ...
    <button
      ...
      className="absolute right-3 top-1/2 -translate-y-1/2 rounded text-muted-foreground/60 hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 dark:focus-visible:ring-cyan-700"
    >
...
const ProfilePage = () => {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-5 px-4 pb-14 pt-3 md:px-6">
      ...
      {/* Profile hero */}
      <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-r from-cyan-500 via-slate-700 to-emerald-500 px-6 py-6 text-white shadow-[0_18px_40px_rgba(2,6,23,0.08)] dark:from-cyan-600 dark:via-slate-800 dark:to-emerald-600 md:px-7 md:py-7">
        ...
        <div className="space-y-5 xl:col-span-5">
              ...
              {isFirebaseUser ? (
                ...
                <div className="overflow-hidden rounded-2xl border border-border bg-muted/20">
                  <button
                    ...
                    className="flex w-full items-center justify-between px-4 py-3.5 transition-colors hover:bg-muted/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-inset dark:focus-visible:ring-cyan-700"
                  >
                        ...
                        <div className="space-y-4 border-t border-border px-4 py-4">
                          ...
                          <div className="flex justify-end pt-1">
                            <button
                              ...
                              disabled={saving}
                              className="inline-flex items-center gap-2 rounded-xl bg-cyan-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-cyan-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-2 disabled:opacity-60 dark:focus-visible:ring-offset-slate-900"
                            >
                              <Save size={14} />
          ...
          <div className="rounded-3xl border border-border bg-gradient-to-br from-slate-50 to-white p-5 shadow-sm dark:from-white/[0.04] dark:to-white/[0.02]">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Only you can see this page. Keep your password unique to this
              account and update it periodically for better security.
            </p>
          </div>
        </div>
