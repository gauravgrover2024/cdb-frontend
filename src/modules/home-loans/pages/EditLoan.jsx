...
const EditLoan = () => {
  ...
  const fetchLoan = async () => {
    try {
      ...
      try {
        const data = await homeLoansApi.getById(loanId);
    ...
    return (
      <div className="p-6 space-y-3">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={() => navigate("/home-loans")}>
            Back to Dashboard
          </Button>
    ...
    <div className="min-h-screen bg-background">
      <div className="w-full">
        <div className="flex items-center justify-between gap-3 px-4 md:px-8 py-4 border-b border-border bg-card">
          ...
          <Button variant="outline" size="sm" onClick={() => navigate("/home-loans")}>
            Back
          </Button>
        </div>
